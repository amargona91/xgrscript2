...
kelas penggunaAgent {
     ...
     */
    publik  $ androidDevices = [ '4.3' => [ 'GT-I9:number2-5:00 Build/JDQ39' ,
                                          'Nokia 3:number1-3:[10|15] Build/IMM76D' ,
                                          '[SAMSUNG |]SM-G3:number1-5:0[R5|I|V|A|T|S] Build/JLS36C' ,
                                          'Naik G3:number0-3:0 Build/JLS36I' ,
                                          ...
                                          'HP :number63-73:5 Pembuatan PC Notebook/[JLS36C|JSS15J]' ,
                               ...
                               '4.4' => [ 'XT10:number5-8:0 Build/SU6-7.3' ,
                                          ...
                                          'Elephone P:number2-66:00 Build/KTU84P' ,
    ...
    public function generate($userAgent = NULL) {
        ...
        if($userAgent == 'chrome') {
            ...
            return  'Mozilla/5.0 (' . $ this -> getMobileOS ( $ userAgent ) . ') AppleWebKit/' . ( random_int ( 1 , 100 ) > 50 ? random_int ( 533 , 537 ) : random_int ( 600 , 603 )) . '.' . random_int ( 1 , 50 ) . ' (KHTML, seperti Gecko) Chrome/' . diri :: chromeVersion (['min' => 47 ,
